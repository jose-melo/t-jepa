#!/bin/bash
#SBATCH --job-name=autoint_tuned_california
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python benchmark.py --config_file=src/benchmark/tuned_config/california/autoint_california_tuned.json --num_runs=20
