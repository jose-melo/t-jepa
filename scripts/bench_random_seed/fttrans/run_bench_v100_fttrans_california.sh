#!/bin/bash
#SBATCH --job-name=fttrans_tuned_california
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python benchmark.py --config_file=src/benchmark/tuned_config/california/ft_transformer_california_tuned.json --num_runs=20
